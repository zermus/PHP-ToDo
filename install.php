...
if (isset($_POST['install'])) {
    ...
    if ($adminPassword !== $verifyPassword) {
        ...
        $message = "Password must be at least 8 characters long and include at least one uppercase letter, one lowercase letter, one num
ber, and one special character.";
 ...
 ?, ?, 'super_admin', ?, ?)");
            ...
            $stmt->execute([$adminName, $adminUsername, $adminEmail, password_hash($adminPassword, PASSWORD_DEFAULT), $verificationToken
, $adminTimezone]);
...
n$verificationLink\n\nThank you!";
            ...
            if (mail($adminEmail, $subject, $emailMessage, $headers)) {
                $message = "Installation completed successfully! Please check your email to verify your account.<br><br>" .
                    ...
                    "3. <strong>Set up a cron job</strong> to run 'send_reminders.php' every minute. You can do this by adding the follo
wing line to your crontab:<br>" .
                ...
                $message = "Installation completed, but the verification email could not be sent. Please check your server's email setti
ngs.";
            }
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div>
                ...
                <div id="passwordMessage" class="password-requirements">Password must be at least 8 characters long and include at least
